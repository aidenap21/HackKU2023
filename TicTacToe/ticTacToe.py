...
class TicTacToe:
    ...
    async def run(self):
        while (running): # game loop
            ...
            gameRunning = True # bool check to see if the current game is complete or not before rerunning game loop
            while (gameRunning): # runs until the current game is complete
                                ...
                                if (self._turnNum % 2 == 0): # runs if it is X's turn
                                    if (self._place(x, y)): # calls place and will return True if successfully places
                                        ...
                                        if (self._winCheck()): # checks if someone has won
                                            screen.blit(x_wins, (20, 160)) # outputs X win screen message
                                    ...
                                    if (self._place(x, y)): # calls place and will return True if successfully places
                                        ...
                                        if (self._winCheck()): # checks if someone has won
                                            screen.blit(o_wins, (20, 160)) # outputs O win screen message
                                            pygame.display.flip() # flips to the display
